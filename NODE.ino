...
void SendMessage()
{
  ...
  delay(1000);
   Serial.println("at");
 Myserial.println(" Hi Dr.Sunny, Your patient is in critical situation. Please go through the details --- Name: SANKARANTAMBI - Age : 82 - Cardiovascular : High blood pressure,Heart Attack, Dizziness -Respiratory: Asthma, Emphysema - Blood Group : A+ - Location :- Latitude: 10.2315 - Longitude : 76.4088");// The SMS text you want to send
  delay(100);
   Serial.println("at");
